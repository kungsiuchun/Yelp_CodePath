# Project 3 - *Yelp_CodePath*

**Yelp_CodePath** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
<img src='https://i.imgur.com/YZjct7N.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

It is hard to implement the map view of restaurant results.

## License

    Copyright [SiuChun] [name of copyright owner]
